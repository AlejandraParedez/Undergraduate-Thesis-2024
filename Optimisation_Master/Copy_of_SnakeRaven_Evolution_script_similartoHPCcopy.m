...
%sample_size = 8*1e6; 
sample_size = 1000; %10   %1.5*1e5; %5*1e5; %6 must be larger than 9100*(18*9) orientation patches **********************************************88
...
for it=1:MaxIt
    ...
    for i=1:nPop
        ...
        if was_tested
            ...
            %Unique Design needs To be calculated
            func_iter = func_iter + 1;
            TrajandTendPlotsetup(it, i, vector2designstruct(NewSol.Position), Voxels, Entranceframe )
            tic
