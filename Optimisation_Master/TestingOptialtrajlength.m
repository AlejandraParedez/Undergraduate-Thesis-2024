...
design_data = load('Design_alpha15708_n3_d3_RVT.mat');
V = load('VoxelData_CylE_22mm_27Mar2025.mat');

%%
EntranceFrame = V.Voxel_data.VoxelBaseFrame;
design = design_data.Design_params;
%Tool Endeffector transfrom to tip
toolframe = txyz(0,0,5); % 5 mm straight tool on the endeffector, tooltransform
voxelsize = V.Voxel_data.voxelsize;


%Determine the Trajectory sampling value based on voxel size and this
%design -> ForwardKinematicsVariableSegmentTraj(EntranceFrame,tooltransform,design,q,dV,traj_length);
